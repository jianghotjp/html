...
function sendData(userid,username,g,f){
	record.push({
			    "userid": userid,
			    "username": username,
			    "content": g,
...
$(document).ready(function() {
		function e() {
			...
			var i = "<div class='message clearfix'>" + 
					"<div class='wrap-text'>" + 
					"<h5 class='clearfix'>"+username+"</h5>" + 
					"<div>" + g + "</div>" + "</div>" + 
					"<div class='wrap-ri'>" + 
					"<div clsss='clearfix'><span>" + f + "</span></div>" + 
					"</div>" + "<div style='clear:both;'></div>" + 
					"</div>";
			null != g && "" != g ? ($(".chat01_content").scrollTop($(".mes1").height()), 
			$("#textarea").val(""), 
			message(),sendData(userid,username,g,f)) : alert("\u8bf7\u8f93\u5165\u804a\u5929\u5185\u5bb9!")
